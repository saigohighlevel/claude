...
function TypewriterPrompt() {
  ...
  return (
    <span style={{ color: '#94a3b8' }}>
      {text}
      <span style={{ borderRight: '2px solid #6366f1', marginLeft: 1, animation: 'blink 1s step-end infinite' }}>&nbsp;</span>
    </span>
  )
}
...
export default function Landing() {
  ...
  return (
    <div style={{ background: '#0a0a0f', minHeight: '100vh', color: '#f1f5f9', overflow: 'hidden' }}>
      {/* Navigation */}
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', fontSize: 14, color: '#94a3b8' }}>
      ...
      <section style={{ position: 'relative', paddingTop: 160, paddingBottom: 120, textAlign: 'center', overflow: 'hidden' }}>
        {/* Background orbs */}
        <Orb style={{ width: 600, height: 600, background: 'radial-gradient(circle, rgba(99,102,241,0.12) 0%, transparent 70%)', top: -100, left: '50%', transform: 'translateX(-50%)' }} />
        <Orb style={{ width: 400, height: 400, background: 'radial-gradient(circle, rgba(139,92,246,0.08) 0%, transparent 70%)', top: 200, left: '15%', animation: 'orb1 12s ease-in-out infinite' }} />
        <Orb style={{ width: 300, height: 300, background: 'radial-gradient(circle, rgba(244,114,182,0.06) 0%, transparent 70%)', top: 100, right: '10%', animation: 'orb2 15s ease-in-out infinite' }} />
        ...
        <div style={{ position: 'relative', maxWidth: 860, margin: '0 auto', padding: '0 2rem' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, color: '#818cf8', fontWeight: 500 }}>AI-powered app builder — now in public beta</span>
          ...
          <p style={{
            ...
            color: '#94a3b8', maxWidth: 560, margin: '0 auto 48px',
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ flex: 1, position: 'relative', display: 'flex', alignItems: 'center', padding: '10px 16px' }}>
                <MessageSquare size={16} color="#6366f1" style={{ flexShrink: 0, marginRight: 10 }} />
                {heroInput === '' ? (
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 24, animation: 'fadeUp 0.6s 0.4s ease both' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <span style={{ fontSize: 13, color: '#94a3b8' }}>
                <strong style={{ color: '#f1f5f9' }}>12,000+</strong> builders already shipping
              </span>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              ...
              <span style={{ fontSize: 13, color: '#94a3b8', marginLeft: 4 }}>4.9/5 rating</span>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            borderRadius: 20,
            overflow: 'hidden',
            boxShadow: '0 40px 120px rgba(0,0,0,0.6), 0 0 80px rgba(99,102,241,0.08)',
          }}>
            {/* Window chrome */}
            <div style={{
              background: 'rgba(10,10,15,0.8)',
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <div style={{
                  ...
                  <Play size={10} fill="#818cf8" /> Preview
                </div>
                <div style={{
                  background: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
                  borderRadius: 6, padding: '4px 12px',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '340px 1fr', height: 460 }}>
              ...
              <div style={{
                ...
                <div style={{ padding: '16px', borderBottom: '1px solid rgba(99,102,241,0.08)', display: 'flex', alignItems: 'center', gap: 8 }}>
                  <Sparkles size={14} color="#6366f1" />
                  <span style={{ fontSize: 13, fontWeight: 600, color: '#f1f5f9' }}>Forge AI</span>
                ...
                <div style={{
                  ...
                  <div style={{
                    flex: 1, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(99,102,241,0.15)',
              ...
              <div style={{ background: 'white', overflow: 'hidden', position: 'relative' }}>
                ...
                <div style={{ background: '#0f172a', height: '100%', overflow: 'hidden' }}>
                  ...
                  <div style={{ background: '#0f172a', borderBottom: '1px solid rgba(255,255,255,0.05)', padding: '12px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    ...
                    <div style={{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', borderRadius: 6, padding: '4px 12px', fontSize: 10, color: 'white', fontWeight: 600 }}>
                      Get started
                    </div>
                  </div>
                  {/* Fake hero */}
                  <div style={{ padding: '32px 24px', textAlign: 'center' }}>
                    <div style={{ fontSize: 11, fontWeight: 500, color: '#818cf8', marginBottom: 8, background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.2)', borderRadius: 100, display: 'inline-block', padding: '3px 10px' }}>✨ Now in beta</div>
                    <h2 style={{ fontSize: 22, fontWeight: 800, color: 'white', margin: '10px 0 8px', lineHeight: 1.2 }}>
                      The platform that<br />
                      <span style={{ background: 'linear-gradient(135deg, #818cf8, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>scales with you</span>
                    </h2>
                    ...
                    <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
                      <div style={{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', borderRadius: 8, padding: '6px 14px', fontSize: 10, color: 'white', fontWeight: 600 }}>Start free trial</div>
                  ...
                  <div style={{ padding: '0 16px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
                    {[
                      ...
                      { name: 'Pro', price: '$29', color: 'rgba(99,102,241,0.12)', border: 'rgba(99,102,241,0.3)', badge: true },
                      ...
                      <div key={p.name} style={{
                        ...
                        <div style={{ background: p.badge ? 'linear-gradient(135deg, #6366f1, #8b5cf6)' : 'rgba(255,255,255,0.06)', borderRadius: 6, padding: '4px', fontSize: 9, color: 'white', textAlign: 'center', marginTop: 6, fontWeight: 600 }}>
                          Get started
                        </div>
                      </div>
                    ))}
      ...
      <section style={{ padding: '100px 2rem', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{
            display: 'inline-block', fontSize: 12, fontWeight: 600, color: '#6366f1',
            letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16,
          }}>How it works</div>
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: 800, letterSpacing: '-0.03em', margin: 0 }}>
            From idea to live app
            <br /><span style={{ background: 'linear-gradient(135deg, #818cf8, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>in four steps</span>
          </h2>
        </div>
      ...
      {/* Features */}
      <section style={{ padding: '100px 2rem', maxWidth: 1100, margin: '0 auto' }} id="features">
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{
            display: 'inline-block', fontSize: 12, fontWeight: 600, color: '#6366f1',
            letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16,
          ...
          <h2 style={{ fontSize: 'clamp(2rem, 4vw, 2.8rem)', fontWeight: 800, letterSpacing: '-0.03em', margin: 0 }}>
            ...
            <br /><span style={{ background: 'linear-gradient(135deg, #818cf8, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>build and ship</span>
          </h2>
        </div>
      ...
      <section style={{ padding: '100px 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <Orb style={{ width: 600, height: 600, background: 'radial-gradient(circle, rgba(99,102,241,0.1) 0%, transparent 70%)', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} />
        <div style={{ position: 'relative', maxWidth: 700, margin: '0 auto' }}>
          <h2 style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: 20, lineHeight: 1.1 }}>
            Start building your
            <br /><span style={{ background: 'linear-gradient(135deg, #818cf8 0%, #c084fc 45%, #f472b6 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>dream app today</span>
          </h2>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button onClick={() => navigate('/dashboard')} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 16px 60px rgba(99,102,241,0.4)' }}
              onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 8px 40px rgba(99,102,241,0.3)' }}
            >
            ...
            <button style={{
              ...
              border: '1px solid rgba(99,102,241,0.2)',
              color: '#818cf8', cursor: 'pointer', fontSize: 15, fontWeight: 600,
              padding: '14px 32px', borderRadius: 12,
              display: 'flex', alignItems: 'center', gap: 8,
              transition: 'all 0.2s', fontFamily: 'inherit',
            }}
      ...
      <footer style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 16, letterSpacing: '-0.02em' }}>Forge</span>
        </div>
        <div style={{ display: 'flex', gap: '2rem', fontSize: 13, color: '#64748b' }}>
          {['Privacy', 'Terms', 'Security', 'Status', 'Blog'].map(item => (
            <a key={item} href="#" style={{ color: '#64748b', textDecoration: 'none' }}
              onMouseEnter={e => (e.currentTarget.style.color = '#94a3b8')}
              onMouseLeave={e => (e.currentTarget.style.color = '#64748b')}
            >{item}</a>
          ))}
        </div>
        <div style={{ fontSize: 13, color: '#475569' }}>© 2025 Forge. All rights reserved.</div>
      </footer>
    </div>
  )
}
